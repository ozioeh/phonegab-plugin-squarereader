...
#warning Dummy application ID must be replaced with the Application ID found in the Square Application Dashboard [https://connect.squareup.com/apps]
NSString *const yourApplicationID = @"sq0idp-6Dn1MPyD0v5_HmeJGLp0rw";//      "sq0idp-yg9rzy2UZaEU3fYEM5_e8Q";
...
- (IBAction)oauth:(id)sender;
{
    NSURL *oauthURL = [NSURL URLWithString:[NSString stringWithFormat:@"https://squareup.com/oauth2/authorize?client_id=%@&scope=PAYMENTS_WRITE&response_type=token", yourApplicationID]];
